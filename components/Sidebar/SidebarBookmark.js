...
export class SidebarBookmark extends LitElement {
  ...
  svgFilled() {
    ...
    >
      <path
        d="M19.9 23.5C19.7 23.5 19.6 23.5 19.5 23.4L12 17.9L4.49999 23.3C4.29999 23.5 3.99999 23.5 3.69999 23.4C3.49999 23.3 3.29999 23 3.29999 22.7V5.6C3.29999 4.4 4.29999 3.4 5.49999 3.4H18.3C19.5 3.4 20.5 4.4 20.5 5.6V22.7C20.5 23 20.3 23.2 20.1 23.4C20.1 23.5 20 23.5 19.9 23.5Z"
        fill="black"
      />
    </svg>`;
  }
